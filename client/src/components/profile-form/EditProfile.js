...
const EditProfile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      stuclass: loading || !profile.stuclass ? '' : profile.stuclass,
      githubusername:
      ...
      <form className="form" onSubmit={(e) => onSubmit(e)}>
        ...
        <div className="form-group">
          <select
            ...
            <option value="M.Sc-1">M.Sc-1</option>
            <option value="M.Sc-2">M.Sc-2</option>
            <option value="Other">Other</option>
          </select>
          <small className="form-text">Tell us your class</small>
        </div>
        <div className="form-group">
          <input
            type="text"
